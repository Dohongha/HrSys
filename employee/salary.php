      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <table id="salary_table" class="table table-bordered">
                <thead>
                  <th>Employee Name</th>
                  <th>Employee ID</th>
                  <th>Gross</th>
...
$(function(){
  ...
  $("#reservation").on('change', function(){
    ...
    window.location = 'salary.php?range='+range;
  });
